 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.security.sso.iam.service.impl.TokenServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class TokenServiceBaseImpl extends BaseServiceImpl
	implements TokenService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portal.security.sso.iam.service.TokenServiceUtil} to access the token remote service.
	 */

	/**
	 * Returns the token remote service.
	 *
	 * @return the token remote service
	 */
	...
	/**
	 * Sets the token remote service.
	 *
	 * @param tokenService the token remote service
	 */
	...
	@BeanReference(type = TokenService.class)
